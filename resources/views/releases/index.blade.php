...
<section class="hk-sec-wrapper">
    <div class="row mb-10">
        ...
        <ul class="nav nav-pills nav-light bg-light pa-15 float-right " role="tablist">
            ...
            <li class="nav-item pr-10">
                <a href="{{route('release.graphics')}}" class="nav-link link-icon-top bg-light border border-light-20"><i class="far fa-chart-bar"></i>Análise</a>
            </li>
            <li class="nav-item pr-10">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($releases as $release)
                            <tr>
                                ...
                                <td>{{$release->cpf}} <span class="badge badge-success badge-pill"></span></td>
