                    ...
                    <div class="table-wrap">
                        <table id="list_1" class="table table-hover w-100 display pb-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$charge->title}}</td>
                                        <td>@if($charge->partner_id) <span class="badge badge-soft-success badge-pill">{{$charge->partner->name}}</span> @else <span class="badge badge-danger badge-pill">Sem CPF Vinculado @endif</span></td>
                                        <td>@if ( $charge->success == '1')
                                        ...
                                        <td>{{$charge->number}}</td>  
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#descriptionCharge_{{$charge->id}}">
