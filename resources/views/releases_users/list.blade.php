                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedColor1">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item  pr-10">
                                    <a class="btn btn-warning btn-sm" href="{{route('releasesuser.charges', $client->id)}}" >
                                    <i class="far fa-calendar-alt"></i > Agendamento</a>
                                </li>
                                <li class="nav-item pr-10">
                                    <a class="btn btn-info  btn-sm" href="{{route('releasesuser.historic', $client->id)}}" >
                                    <i class="far fa-file-alt"></i> Histórico
                                    </a>                                    
                                </li>
                            </ul>
                            ...
                            <ul class="navbar-nav align-items-center flex-row">   
                                <li class="nav-item pr-10">
                                    <a class="btn btn-purple  btn-sm" data-toggle="collapse" href="#newCharge" role="button" aria-expanded="false" aria-controls="collapseExample" >
                                    <i class="far fa-money-bill-alt"></i> Cobrar
                                    </a>                                    
                                </li>
                                <li class="nav-item pr-10">
                                    <a class="btn btn-success btn-sm" href="{{route('releasesuser.manage', $client->id)}}" >
                                    <i class="fas fa-sync-alt"></i> Gerenciar
                                    </a>                                    
                                </li>
                            </ul>
                        </div>
