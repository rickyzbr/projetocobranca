                                                ...
                                                @foreach($releases as $release)
                                                    @if($release->status_id != $status->id)                                                
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $mytime->diffInDays($release->due_date)}}</td>
                                                ...
                                                @foreach($releases as $release)
                                                    @if($release->status_id != $status->id)                                                
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $mytime->diffInDays($release->due_date)}}</td>
                                                            <td>R$ {{ number_format($release->amount, 2, ',','.') }}</td>
                                                            <td>R$ {{ number_format((0.02 * $release->amount + $release->amount) + ($mytime->diffInDays($release->due_date) * $release->amount * 0.01), 2, ',','.') }}</td>
                                                            <td><pan class="badge badge-{{$release->status->color}} badge-pill">{{$release->status->name}}</span></td>
