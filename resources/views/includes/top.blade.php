...
<nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="index.html">
                <img class="brand-img d-inline-block" src="{{ url('dist/img/logo_criare.png') }}" alt="brand" />
            </a>
			<ul class="navbar-nav hk-navbar-content order-xl-2">
                ...
                <li class="nav-item dropdown dropdown-notifications">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <h6 class="dropdown-header">Notificações <a href="javascript:void(0);" class="">View all</a></h6>
                        ...
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    ...
                                    <img src="{{ url('storage/users/'.auth()->user()->image) }}" class="avatar-img rounded-circle" alt="{{ auth()->user()->image }}" >
                                    @else
                                    <img src="{{ url('dist/img/default-user.png') }}" class="avatar-img rounded-circle" alt="{{ auth()->user()->image }}" > 
                                    @endif
                                </div>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-0">
					...
					<li class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Vendas</a>
